    ...
    <>
      ...
      <div>
        ...
        <Modal show={show} onHide={handleClose}>
          ...
          <Modal.Body>
            <iframe width={"100%"} height={'400px'} src={`${card?.url}?autoplay=1`}
              title="Scene Mone - Music Video | RDX | Neeraj Madhav, Shane Nigam,Antony Varghese
              | Nahas Hidhayath | Rzee" frameborder="0" allow="accelerometer; autoplay; clipboard-write; 
